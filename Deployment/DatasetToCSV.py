...
<<<<<<< HEAD
            if not os.path.isdir(type_dir_path):  # 检查是否为目录
                continue
=======
...
<<<<<<< HEAD
                if not os.path.isdir(patient_dir_path):  # 检查是否为目录
                    continue
=======
>>>>>>> f30e8c53672116fdef800be7ef7885daca1352c8
...
<<<<<<< HEAD
                    if not os.path.isdir(zoom_dir_path):  # 检查是否为目录
                        continue
=======
>>>>>>> f30e8c53672116fdef800be7ef7885daca1352c8
...
<<<<<<< HEAD
                        if not img_file_path.endswith(('.png', '.jpg', '.jpeg')):  # 只处理图像文件
                            continue
=======
>>>>>>> f30e8c53672116fdef800be7ef7885daca1352c8
